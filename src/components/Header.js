    ...
    return(
        <>
            <header>
                ...
                .....
                {/*BIGGER SCREEN*/}
                <div className={"hidden md:block w-full bg-gray-50 text-black py-3 px-8 shadow"}>
                    ...
                    <div className={"flex justify-between items-center"}>
                        ...
                        <div>
                            <nav>
                                <ul className={"flex flex-nowrap gap-4"}>
                                    <li><a href={"#"} className={"hover:text-primary"}>Link1</a></li>
                        ...
                        {/*SECTION LOGO*/}
                        <div><img src={logo} width={50} alt={"react logo"}/></div>
                ...
                {/*SMALLER SCREEN*/}
                <div className={"w-full bg-transparent text-black md:hidden py-3 px-5"}>
                    <div className={"flex justify-between flex-nowrap"}>
                        <div><button onClick={()=>setToggle(true)}><Icon path={mdiMenu} size={1}/></button></div>
                        <div><img src={logo} alt={"react logo"} width={50}/> </div>
